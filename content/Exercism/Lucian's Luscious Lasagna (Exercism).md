...
Both time and space complexity for all functions in this challenge are $O(1)$ as we don't loop and don't need any fancy data structures to store the data.
